# Streamdata.io API Gallery - 3D Robotics Profiling
This is a repository for managing the profiling of 3D Robotics. Right now, it is just a Github repository, README, and an [APIs.json](apis.md) outlining some of the details of 3D Robotics, including different links and artificats defining their operation.
...
Once there is an OpenAPI for 3D Robotics, it will be available within the [Streamdata.io API Gallery](http://api.gallery.streamdata.io/), until then the companies profile will be used in a variety of other sites and applications.
